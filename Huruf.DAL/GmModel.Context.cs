...
namespace Huruf.DAL
{
    ...
    public partial class GmContext : DbContext
    {
        ...
        public virtual ObjectResult<GetBlogList_Result> GetBlogList(Nullable<int> categoryID, Nullable<int> blogID)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<GetBlogList_Result>("GetBlogList", categoryIDParameter, blogIDParameter);
        }
    }
}
